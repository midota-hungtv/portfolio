  ...
  return [
    {
      ...
      description: {
        ...
        id_ID:
          "Tôi xây dựng các trang web và ứng dụng hiện đại và nâng cao bằng React hoặc NextJS.",
      },
      icon: "devicon:react",
      image: null,
    },
    {
      ...
      description: {
        ...
        id_ID:
          "Tôi sử dụng Vue hoặc NuxtJS, một khung JavaScript và Typescript hiện đại, đồng thời tạo các trang web và ứng dụng động và tĩnh.",
      },
      icon: "devicon:vuejs",
      image: null,
    },
    {
      ...
      description: {
        ...
        id_ID:
          "Về phía back end Tôi sử dụng NodeJS cho hầu hết các ứng dụng cá nhân của mình để thao tác với cơ sỡ dữ liệu.",
      },
      icon: "devicon:nodejs",
      image: null,
    },
